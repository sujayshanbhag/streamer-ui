...
export const LoginPage = () => {
  ...
  const handleSuccess = async (token: string, type: "google" | "github") => {
    try {
      const { data } =
        type === "google"
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-neutral-50 dark:bg-neutral-950 gap-8">
      {/* Logo */}
      ...
      {/* Card */}
      <div className="w-80 bg-white dark:bg-neutral-900 rounded-2xl shadow-lg border border-neutral-200 dark:border-neutral-800 overflow-hidden">
        {/* Tabs */}
